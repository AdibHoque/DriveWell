...
function Hero() {
  return (
    <div className="relative bg-[url('/images/banner/5.jpg')] bg-cover bg-center rounded-xl h-[85vh]">
      <div className="rounded-xl absolute inset-0 bg-gradient-to-r from-[rgb(21,21,21)] to-[rgb(21,21,21)] lg:via-[rgba(21,21,21,0.60)] lg:to-[rgba(21,21,21,0)] opacity-70 lg:opacity-100"></div>
